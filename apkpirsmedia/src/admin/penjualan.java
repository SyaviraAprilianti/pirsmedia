...
DefaultTableModel model = new DefaultTableModel();
    ...
    private void tampilDatapenjualan() {
        int row = tbpenjualan.getRowCount();
        for (int a = 0; a < row; a++) {
            model.removeRow(0);
        }
        ...
        try {
            ...
            while (rs.next()) {
                //langkah ini berguna untuk menampung data sementaraString tanggaltransaksi = rs.getString("tanggal_transaksi");
                ...
                String[] data = {tanggaltransaksi,namakaryawan,judulbuku,harga,jumlah,totalharga};
